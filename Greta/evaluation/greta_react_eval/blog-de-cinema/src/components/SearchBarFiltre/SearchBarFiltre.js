...
import "./SearchBarFiltre.css";

const API_KEY = "48a751c85b6b3d4c0750582c52468efb";
const API_URL = "https://api.themoviedb.org/3/search/movie";

const SearchBarFiltre = ({ placeholder, value, onChange }) => {
  ...
  return (
    <div className="search-bar-with-suggestions">
      ...
      {suggestions.length > 0 && (
        <ul className="search-bar-with-suggestions-suggestions-list">
...
export default SearchBarFiltre;
